...
>   7. 人主动要求压缩，就是新交办的一轮：先出现你的要求（「压缩上下文」，后面跟人写的补充也带上），过程跟在后面。上一场已经结束或失败的，这一轮跟在那场收场后面，不要插进「任务失败」前面。它干活当中自己压，仍是那场里的步骤。
...
> - **明确不做**：不因此清空对话；不在它干活时硬压；不为了省事按远近砍原文。正在干活才说一声等结束；空对话才说没什么可压。人已经点名之后，不要再拦一道「范围够不够」。不把人点名的压缩塞回上一场过程里。
>
