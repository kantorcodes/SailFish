...
export default {
  ...
  ai: {
    ...
    inputPlaceholderSupplement: 'Supplement (Enter) · Queue ({shortcut})',
    inputPlaceholderEditFollowUp: 'Editing queued message — Enter saves it back…',
    ...
    followUpEditSave: 'Save back to queue (Enter)',
    ...
    slashCompactDesc: 'Hand off this conversation to free space',
    slashHintKey: 'Tab to complete · Enter to run',
    slashCompacting: 'Handing off…',
    slashCompacted: 'Handed off, freed about {freed} tokens',
    slashCompactEmpty: 'Nothing to compress',
    slashCompactRunning: 'Wait until this run finishes',
    slashCompactFailed: 'Handoff failed',
    contextComposition: {
