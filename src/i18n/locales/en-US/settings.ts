...
export default {
  ...
  settings: {
    ...
    security: {
      builtinRules: {
        ...
        hardBlockedPathsDesc: 'Deleting or overwriting critical paths is blocked (irreversible damage). Changing permissions or ownership there requires confirmation. Hardened paths always require confirmation. userData is blocked for read and write by default; logs and conversation history are read-only.',
        systemPatterns: 'System Paths',
        systemPatternsCritical: 'Critical (delete/overwrite blocked; chmod/chown confirm)',
  ...
  aiSettings: {
    ...
    modelRecommendation: '',
    model: 'Model Name',
    modelPlaceholder: 'e.g., qwen3.7-plus, gpt-5.6',
    proxy: 'Proxy',
    proxyPlaceholder: 'http://proxy:port (optional)',
    contextLength: 'Context Length',
    contextLengthHint: 'tokens',
    contextLengthTooSmall: 'Small context; longer tasks tend to lose earlier information. 128K or more recommended. You can still save and use it.',
    confirmSmallContextTitle: 'Small Model Context',
    confirmSmallContext: 'This model handles about {size}K at a time. 128K or more is recommended.',
    confirmSmallContextDetail: 'While working on a task, the model needs to retain files it has read and command results. With a small context, longer tasks tend to lose earlier information and go wrong later on. Simple questions are unaffected.',
    confirmSmallContextConfirm: 'Use Anyway',
    confirmSmallContextCancel: 'Go Back',
    ...
    templates: {
      openai: 'OpenAI official API, defaults to GPT-5.6',
      qwen: 'Alibaba Qwen, defaults to Qwen 3.7 Plus',
      deepseek: 'DeepSeek V4 Flash Vision — everyday use plus images, no linked vision model needed',
      doubao: 'ByteDance Doubao, defaults to Seed 2.1 Pro',
      zhipu: 'Zhipu GLM, defaults to GLM-5.3',
      kimi: 'Moonshot Kimi, defaults to Kimi K3',
      minimax: 'MiniMax LLM, defaults to M3 with long context support',
      claude: 'Anthropic Claude Opus 5, strong on complex work, 1M-token context',
      gemini: 'Google Gemini 3.7 Flash, fast multimodal, 1M-token context',
      grok: 'xAI Grok 4.6, strong coding and reasoning',
    ...
    packageRowDescWithDumps: 'Also includes crash dumps (memory snapshots taken at crash time, which may contain local paths) — {count} kept on this machine; send this one only for hard-to-diagnose issues',
  ...
  knowledgeSettings: {
    ...
    embeddingDeviceDesc: 'Compute device for local vectorization. Auto uses WebGPU on macOS (CoreML does not currently support external weight paths).',
    ...
    memoryLengthGroup: 'Length',
    memoryMaxChars: 'Each memory',
    memoryMaxCharsUnit: 'chars',
    memoryMaxCharsHint: 'A higher limit retains more content and uses more of each conversation’s context budget. Existing content is not truncated immediately.',
    maintainGroup: 'Maintenance',
    repairLabel: 'Index',
    ...
    autoSaveUploadsDesc: 'Uploaded documents are added to the knowledge base automatically.',
